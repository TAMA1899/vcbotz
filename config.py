...
class Config:
    ...
    #Stream 
    STREAM_URL=os.environ.get("STARTUP_STREAM", "https://www.youtube.com/watch?v=8NzYo0jmYek")
   
    #Database
    DATABASE_URI=os.environ.get("DATABASE_URI", None)
    DATABASE_NAME=os.environ.get("DATABASE_NAME", "ALBINPRAVEEN")
...
__Example: To set up a__ `REPLY_MESSAGE` __use__ `/env REPLY_MESSAGE=Hey, Check out @musicwithalby rather than spamming in my PM`__
...
4. `SESSION_STRING` : __Generate From here [GenerateStringName](https://repl.it/@ALBINPRAVEEN1/getStringName)__
